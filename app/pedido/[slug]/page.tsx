            ...
            <CardContent className="space-y-5 p-6 sm:p-8">
              ...
              <div className="grid gap-3 rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-surface)] p-4 text-sm text-[var(--theme-muted)]">
                <p className="flex items-start gap-2">
                  ...
                  {produto.productType?.allowsMultiple && produto.productType.minQuantity ? `Quantidade mínima de ${produto.productType.minQuantity} unidades.` : `${produto.totalUnidades} unidades por item adicionado.`}
                </p>
                <p className="flex items-start gap-2">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-[var(--theme-accent)]" />
                  {produto.productType?.allowsMultiple && produto.productType.minQuantity ? `Até ${produto.maxTiposSalgado} tipos por lote de ${produto.productType.minQuantity} unidades.` : `Até ${produto.maxTiposSalgado} tipos diferentes por item.`}
                </p>
                <p className="flex items-start gap-2">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-[var(--theme-accent)]" />
