            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                {isPaid
                  ...
                  : "Recebemos o retorno do pagamento. Se a aprovação ainda não apareceu, atualize esta página em instantes."}
              </p>
            </div>
              ...
              <div className="rounded-[1.4rem] border border-[#d6e7a2] bg-[#fbfff0] p-5 text-left">
                ...
                <div className="mt-4 space-y-3 text-sm text-slate-700">
                  ...
                  <div className="border-t border-[#d6e7a2] pt-3">
                    <div className="flex items-center justify-between text-base font-black text-[#0b3d18]">
                      <span>Total</span>
